...
exports.drawFace = function(scale, eyesNum, mouthNum, peek, offset) {
  ...
  // Face features
  drawFeature(features.mouth[mouthNum ?? exports.settings.mouthNum], exports.settings.mouthColour);
  ...
  if (peek) {
    ...
    drawFeature(features.eyes[eyesNum ?? exports.settings.eyesNum], exports.settings.eyesColour);
  }

  // Draw face
  let xOffset = (g.getWidth() - (exports.faceW * scale)) / 2;
  let yOffset = (offset ?? 0) + ((g.getHeight() - (exports.faceH * scale)) / 2);
  g.setBgColor(0, 0, 0);
